...
export const FormatPromptForScenario = (PlayerData, NpcData, Prompt) => {
    var PromptList = []
    var systemPrompt = "You are a scenario generator, given two characters and a topic generate a scenario with a focus, don't be vague, and add a conflict, end with the start of the scenario, not a question. do not respond with anything or explain yourself, keep it short and to the point."
